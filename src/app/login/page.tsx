                ...
                className="w-full max-w-md">
                    ...
                    <div className="bg-white rounded-2xl shadow-xl p-8 space-y-6">
                        ...
                        <div className="text-center space-y-3">
                            ...
                            <p className="text-muted-foreground">Please login to view your templates</p>
                        </div>
                        ...
                        <form className="space-y-4">
                            <div className="space-y-2">
                                ...
                                <Input id="email" type="email" placeholder="Please enter your email" value={email} onChange={(e)=>setEmail(e.target.value)} required></Input>
                            </div>
                            <div className="space-y-2">
                                <Label htmlFor="password">Password</Label>
                                {/* relative is means to reference this div later when we change the positioning of objects */}
                                <div className="relative"> 
                                    <Input id="password" placeholder="Please enter your password" value={password} onChange={(e)=>setPassword(e.target.value)} required></Input>
